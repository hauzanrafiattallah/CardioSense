...
export const heroMetrics = [
  {
    ...
    value: "78 BPM",
    icon: HeartPulse,
    className: "left-3 top-4 sm:left-5 sm:top-6 lg:-left-8 lg:top-8",
    delay: 0,
  },
  {
    title: "Tekanan Darah",
    value: "Siap dicek",
    icon: Stethoscope,
    className: "right-3 top-20 sm:right-4 sm:top-24 lg:-right-4",
    delay: 0.25,
  },
  {
    ...
    value: "Siap",
    icon: ShieldCheck,
    className: "-bottom-6 left-6 sm:-bottom-4 sm:left-14 lg:-bottom-2",
    delay: 0.45,
  },
];
